...
{
	//aixo es fa per veure com updatear el sprite per, per exemple que camini d'una forma realista amb molts sprites.
...
{
	//modelview i coordenades de textura
